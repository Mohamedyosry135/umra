...
class CustomSearchField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      style: TextStyles.textMedium18.copyWith(color: const Color(ColorCode.splashStart),fontWeight: FontWeight.w300,fontSize: 12,fontFamily: 'CAIRO'),
      decoration: decoration??InputDecoration(
        hintText: hint,
        hintStyle: TextStyles.textMedium18.copyWith(color: const Color(ColorCode.splashStart).withOpacity(.7),fontWeight: FontWeight.w300,fontSize: 20,),

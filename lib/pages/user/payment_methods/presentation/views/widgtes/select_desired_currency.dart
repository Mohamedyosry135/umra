...
class SelectDesiredCurrency extends GetView<BankAccountController> {
  const SelectDesiredCurrency({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Obx((){
      return BeneficiaryInfoWidget(
        ...
        cellTitle: UserLang.selectDesiredCurrency.tr(),
        cellWidget: Container(
          padding: const EdgeInsets.all(15),
          child: Column(
            children: [
              CustomText(text: UserLang.selectDesiredCurrency.tr(),
